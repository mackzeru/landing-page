...
const SocialIcons = ({ links }: { links: SocialLink[] }) => (
  <div className="flex space-x-4">
    {links.map((social) => (
      ...
      >
        <div className="w-6 h-6 text-gray-600 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
          {social.icon}
        </div>
      </a>
    ))}
    ...
    <div className="flex flex-col lg:flex-row justify-between items-center space-y-6 lg:space-y-0">
      <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-8">
        ...
        <div className="flex items-center space-x-6">
          {["Security", "GDPR", "Cookies"].map((item) => (
            <a
              key={item}
              href="#"
...
const Footer = () => {
  ...
  const productLinks: FooterLink[] = [
    ...
    { label: "Multi-Source Search", href: "#" },
    { label: "LinkedIn Plugin", href: "#" },
    ...
    <footer className="relative bg-white dark:bg-gray-900 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8 py-20">
        ...
        <div className="grid lg:grid-cols-5 md:grid-cols-2 gap-12 mb-16">
          ...
          {/* Other Sections */}
          <FooterLinksSection title="Product" links={productLinks} />
          <FooterLinksSection title="Company" links={companyLinks} />
          <FooterLinksSection title="Support" links={supportLinks} />
        </div>
