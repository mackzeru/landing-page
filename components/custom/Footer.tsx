...
const FooterLinksSection = ({ title, links }: FooterSection) => (
  <div className="space-y-8">
    <h3 className="font-bold text-gray-700 dark:text-white text-xl">{title}</h3>
    <ul className="space-y-5">
      {links.map((link) => (
        <li key={link.label}>
          <a
            href={link.href}
            className="text-gray-600 dark:text-gray-300 text-lg hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-300 relative inline-block group"
          >
  ...
  <div className="border-t border-gray-200 dark:border-gray-700 pt-10">
    <div className="flex flex-col lg:flex-row justify-between items-center space-y-6 lg:space-y-0">
      <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-8">
        <p className="text-gray-500 dark:text-gray-400 text-lg text-center sm:text-left">
        ...
        <div className="flex items-center space-x-6">
          {[
            ...
            <a
              key={item.label}
              href={item.href}
              className="text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-300 relative inline-block group"
            >
              <span className="relative">
                {item.label}
...
const Footer = () => {
  ...
  const legalComplianceLinks: FooterLink[] = [
  ...
  const socialLinks: SocialLink[] = [
    {
      name: "LinkedIn",
      href: "https://linkedin.com/company/leelu-ai",
      icon: (
    ...
    {
      name: "Twitter",
      href: "https://twitter.com/leelu_ai",
      icon: (
    ...
    {
      name: "YouTube",
      href: "https://youtube.com/@leelu-ai",
      icon: (
    ...
    {
      name: "Pinterest",
      href: "https://pinterest.com/leeluai",
      icon: (
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid lg:grid-cols-5 md:grid-cols-2 gap-12 mb-16">
          ...
          <FooterLinksSection
            ...
            links={marketingProductLinks}
          />
          <FooterLinksSection
            title="Legal & Compliance"
            links={legalComplianceLinks}
          />
          <FooterLinksSection
            title="Trust & Company"
            links={trustCompanyLinks}
          />
        </div>
